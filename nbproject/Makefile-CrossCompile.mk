...
${OBJECTDIR}/connect_tester.o: connect_tester.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -Wall -I../../opt/toolchains/hndtools-mipsel-linux-uclibc-4.2.3/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/connect_tester.o connect_tester.c
...
${OBJECTDIR}/mb_tcp_machine.o: mb_tcp_machine.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -Wall -I../../opt/toolchains/hndtools-mipsel-linux-uclibc-4.2.3/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/mb_tcp_machine.o mb_tcp_machine.c
